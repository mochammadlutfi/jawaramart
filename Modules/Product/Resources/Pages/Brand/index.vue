                    ...
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-4">
                                <ImageUpload 
                                    :image="(typeof form.image === 'string') ? asset(form.image) : null" :height="'135px'" :ratio="1/1"
...
export default {
    ...
    methods :{
        ...
        submit: function(){
            ...
            let url = this.editMode ? this.route("admin.product.brand.update") : this.route("admin.product.brand.store");
            form.post(url, {
                preserveScroll: true,
                onSuccess: () => {
                    this.$swal.fire({
        ...
        doSearch : _.throttle(function(){
            this.$inertia.get(this.route('admin.product.brand.index', { search : this.search }), {
                preserveScroll : true,
            })
        }, 200),
        select() {
