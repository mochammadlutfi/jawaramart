                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <b-form-radio-group id="radio-group-2" v-model="step1.jk" name="field-jk">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <b-form-radio-group id="radio-group-2" v-model="step1.perkawinan" name="field-perkawinan">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <b-form-radio-group id="radio-group-2" v-model="step1.tipe" name="field-status">
    ...
    methods: {
        ...
        onNext(){
            if(this.current_step === 1){
                ...
                let url = this.route("admin.kop.anggota.store");
                form.post(url, {
                    preserveScroll: true,
