    ...
    <BaseLayout>
        <section class="content content-full">
            <div class="content-heading">
                ...
                <div>Menampilkan {{ products.total }} produk untuk "{{ category.name }}" <small>({{ products.current_page }} - {{ products.to }} dari {{ products.total }})</small></div>
            </div>
            <div class="row">
                <div class="col-6 col-lg-2 col-md-2 mb-15 px-5" v-for="data in allData" :key="data.id">
...
export default {
    ...
    methods: { 
        ...
        orderBy(value){
            ...
            this.$inertia.get(this.route('product.category', params), {
                preserveScroll : true,
            });
        },
        loadMorePosts() {
            ...
            this.$inertia.get(this.route('product.category', params), {}, {
                ...
                onSuccess: () => {
                    ...
                    // var result = Object.values(this.dataList.data);
                    // this.allData = [
                    // ...this.allData,
                    // ...result,
                    // ];
                    // this.page = this.dataList.current_page;
                },
                onFinish: () =>{
                    this.loading = false;
                }
