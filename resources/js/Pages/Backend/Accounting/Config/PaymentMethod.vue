                    ...
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group" v-if="form.type == 'online'">
                            <label for="field-bank_id">Bank</label>
                                <v-select :options="bankList" v-model="form.bank_id" :class="{'is-invalid' : errors.bank_id }" :reduce="bank => bank.id">
                        ...
                        <div class="form-group">
                            <label for="field-logo">Logo</label>
                            <ImageUpload :image="(typeof form.image === 'string') ? asset(form.image) : null"
                                height="100" width="200" :ratio="200/100" @done="(image) => form.image = image"
    ...
    export default {
        ...
        methods: {
            ...
            submit: function () {
                ...
                let url = this.editMode ? this.route("admin.accounting.config.payment_method.update") : this.route(
                    "admin.accounting.config.payment_method.store");
                form.post(url, {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.$swal.fire({
