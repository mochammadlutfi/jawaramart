                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <CustomerSelect @done="(value) => form.customer_id = value" :data="(editMode) ? data.customer : null" :error="errors.customer_id"/>
                                ...
                                <div class="form-group">
                                    <div class="input-group style-2">
                                        ...
                                        <div class="input-group-append">
                                            <BrowseProduct @select="data => addCart(data)" type="sales"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            form.post(url, {
                ...
                onSuccess: () => {
                    return this.$swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: `Sale Order Added Successfully!`,
                        showCancelButton: true,
                        confirmButtonText: 'Add Another',
                    }).then((result) => {
                        if (result.isConfirmed) {
                            this.$inertia.visit(this.route("admin.sale.order.create"));
                        }
                    });
                },
                onError :() => {
