<template>
    <BaseLayout title="Detail Sale">
        <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-4 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="gutters-tiny row">
                                ...
                                <div class="col-lg-9 value">
                                    <span class="font-w700">{{ data.purchase.ref }}</span>
                                </div>
                            </div>
                            <div class="gutters-tiny row">
                                <div class="col-lg-3">Return Date</div>
                                <div class="col-lg-9 value">
                                    <span class="font-w700">{{ format_date(data.purchase.date) }}</span>
                                </div>
                            </div>
                            <div class="gutters-tiny row">
                                <div class="col-lg-3">Supplier</div>
                                <div class="col-lg-9 value">
                                    <a href="#">{{ data.purchase.supplier.name }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Payment -->
            <payment-table type="App\Models\PurchaseReturn" :id="data.id" :amount_due="data.grand_total - data.total_paid" :url="this.route('admin.purchase.return.payment')"/>
        </div>
...
export default {
    ...
    computed :{
        duePayment(){
            return this.data.grand_total - this.data.total_paid;
        }
    },
    mounted(){
    },
