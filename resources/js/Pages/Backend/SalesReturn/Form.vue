                ...
                <div class="block block-bordered block-shadow block-rounded">
                    <div class="block-content pb-15">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="field-supplier">Customer</label>
                                    <div class="form-control-plaintext font-w700">{{ data.customer.name }}</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        submit: function(){
            ...
            let url = this.editMode ? this.route("admin.sale.return.update") : this.route("admin.sale.return.store");
            this.$swal.fire({
                title: 'Please Wait...',
                text: '',
            ...
            form.post(url, {
                ...
                onSuccess: () => {
                    ...
                    return this.$swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: `Sale Return Added Successfully!`,
                        showCancelButton: false,
                        showConfirmButton: false,
                    });
                },
        ...
        fillData(){
            this.title = 'Create Sale Return';
            this.form.sale_id = this.data.id;
