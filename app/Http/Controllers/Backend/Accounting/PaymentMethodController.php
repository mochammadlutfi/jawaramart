...
class PaymentMethodController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Backend/Accounting/Config/PaymentMethod', [
            'dataList' => fn () => $data,
            'bankList' => fn () => $bank
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()){
            ...
            DB::commit();
            return redirect()->route('admin.accounting.payment_method.index');
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()){
            ...
            DB::commit();
            return redirect()->route('admin.accounting.config.payment_method.index');
        }
    }
