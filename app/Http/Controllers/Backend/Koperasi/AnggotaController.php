...
namespace App\Http\Controllers\Backend\Koperasi;
...
use App\Models\Koperasi\Anggota;
use App\Models\Koperasi\AnggotaAlamat;
...
class AnggotaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dataList = Anggota::where(function($q) use ($keyword){
            $q->where('anggota_id', 'like', '%' . $keyword . '%')
              ->orWhere('nama', 'like', '%' . $keyword . '%');
        })
        ->orderBy('anggota_id', 'DESC')->paginate(20);

        return Inertia::render('Backend/Koperasi/Anggota/Index', [
            'dataList' => $dataList
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Backend/Koperasi/Anggota/Create',[
